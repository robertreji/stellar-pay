      ...
      <main className="flex-1 p-6 pb-24 max-w-[760px] mx-auto w-full flex flex-col gap-6 bg-bg-main xl:ml-0 xl:max-w-none xl:p-10 xl:h-screen xl:overflow-y-auto">
        ...
        {activeTab === "home" && (
          <>
            ...
            {/* CONTACTS Section */}
            <div className="bg-white border border-[#164A3A]/8 rounded-[20px] sm:rounded-[24px] p-4 sm:p-5 flex flex-col gap-3.5 sm:gap-4 shadow-[0_8px_30px_rgba(22,74,58,0.02)] w-full shrink-0">
            ...
            <div className="bg-white border border-[#164A3A]/8 rounded-[28px] overflow-hidden shadow-[0_8px_30px_rgba(22,74,58,0.02)] group hover:shadow-md transition-all duration-300 flex flex-col relative shrink-0">
            ...
            {!announcementDismissed && (
              <div className="bg-bg-card border border-border-theme rounded-2xl p-4 flex justify-between items-center shadow-md animate-[fadeIn_0.3s_ease] shrink-0">
